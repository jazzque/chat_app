$(document).ready(function(){
  ...
  head = canvasBody.getBoundingClientRect().top;
  w = canvasBody.width = window.innerWidth,
  h = canvasBody.height = window.innerHeight - head,
  ...
  canvasBody.addEventListener("click", function(e){
    particles.push( new Particle(e.pageX, e.pageY - canvasBody.getBoundingClientRect().top));
  });
